...
const API_BASE_URL = "https://localhost:7213/api/sdxl/";

@Injectable({
  providedIn: 'root'
})
export class SdxlService {
  // private apiUrl = 'https://localhost:7213/api/sdxl/generate'; // Replace with your .NET API URL
  private apiUrl = 'http://wishapic.runasp.net/api/sdxl/generate';
